            ...
            switch (wybor) {
                ...
                case 3:
                    ...
                    for(int i = 1; i <= 1000; i++){
                        ...
                        System.out.println("Czas dla liczby wątków: "+i+" ,wynosi: "+wynik/100+" [ms]\n");
                    }
                    break;
                case 4:
        ...
        do {
            ...
            switch(wybor){
                case 1:
                    ...
                    System.out.println(">Ile watkow: ");
                    int liczbaWatkow = scanner.nextInt();
                    e = new ErastothenesSieve(size,liczbaWatkow);
                    System.out.println("\n");
                    break;
                case 2:
                    e.start();
                ...
                case 3:
                    ...
                    for(int i=1; i<=1000; i++) {
                        double wynik = 0;
                        for(int j=0; j<100; j++) {
                            e = new ErastothenesSieve(1000,i);
                            e.start();
                            wynik += e.time();
                        }
                        System.out.println("Czas dla liczby watkow: "+i+" ,wynosi: "+wynik/100+" [ms]\n");
                    }
                    break;
                case 4:
                    System.out.println("ROZPOCZYNAM ZAPIS");
                ...
                case 4:
                    ...
                    try {
                        ...
                        for(int i=1; i<=1000; i++){
                            double wynik=0;
                            for(int j=0; j<100; j++){
                                m = new Matrix(1000,100,100,1000,i);
                                try {
                                    m.start();
                                } catch (InterruptedException e) {
                                    e.printStackTrace();
